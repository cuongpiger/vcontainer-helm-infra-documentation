...
|9|`vks.vngcloud.vn/listener-allowed-cidrs`|Access control list (ACL) to limit incoming traffic to a listener to a set of allowed source IP addresses (CIDRs).|- Default: `0.0.0.0/0`.|